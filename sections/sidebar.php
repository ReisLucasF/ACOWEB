...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsedispositivos"
        ...
        <span>Script Dispositivo</span>
    </a>
    <div id="collapsedispositivos" class="collapse" aria-labelledby="headingUtilities"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Criar:</h6>
                <a class="collapse-item" href="https://<?php echo $domain; ?>/lista_permissiva/index.php">Criar scritp</a>
         </div>
    </div>
</li>
